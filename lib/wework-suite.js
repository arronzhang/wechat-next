...
class WeworkSuite extends Base {
  /**
   * Wework suite api
   *
   * @param {Object} params
  ...
  getAccessToken(...data) {
    data = this.composeParams(['suite_id', 'suite_secret', 'suite_ticket'], null, ...data)
  ...
  getAuthorizeURL(params = {}) {
    params = Object.assign(
      {
        appid: params.suite_id || this.$params.suite_id,
        redirect_uri: this.$params.redirect_uri || '',
