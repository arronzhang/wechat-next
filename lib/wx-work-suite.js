...
class WxWorkSuite extends BaseApi {
  /**
   * WxWork suite api
   *
   * @param {Object} params
  ...
  constructor(params, config) {
    super(params, config, 'https://qyapi.weixin.qq.com/', 'suite_access_token')
  }
  ...
  getAccessToken(...data) {
    ...
    return this.request('cgi-bin/service/get_suite_token', { method: 'post', data }).then(
      (data) => {
        this.accessToken = {
...
exports.WxWorkSuite = WxWorkSuite
